...
router.patch("/members/:nik", async (req, res): Promise<void> => {
  ...
  if (d.targetInspeksi !== undefined) updateData.targetInspeksi = d.targetInspeksi;
  if (d.targetObservasi !== undefined) updateData.targetObservasi = d.targetObservasi;
  if (d.targetOpkKeberadaanPengawas !== undefined) updateData.targetOpkKeberadaanPengawas = d.targetOpkKeberadaanPengawas;
  if (d.targetOpkFungsiPengawas !== undefined) updateData.targetOpkFungsiPengawas = d.targetOpkFungsiPengawas;
  if (d.targetOpkP2h !== undefined) updateData.targetOpkP2h = d.targetOpkP2h;
  if (d.targetOpkSeatbelt !== undefined) updateData.targetOpkSeatbelt = d.targetOpkSeatbelt;
  if (d.targetOpkSimper !== undefined) updateData.targetOpkSimper = d.targetOpkSimper;
  if (d.targetOpkRoster !== undefined) updateData.targetOpkRoster = d.targetOpkRoster;
  if (d.targetOpkFatigue !== undefined) updateData.targetOpkFatigue = d.targetOpkFatigue;
  if (d.targetOpkLototo !== undefined) updateData.targetOpkLototo = d.targetOpkLototo;
